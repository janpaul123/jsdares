...
.editor-toolbar {
	...
	.editor-toolbar-run-bar {
		.editor-toolbar-reload {
			background-image: -webkit-linear-gradient(top, #4EB9EE, #05C);
		...
		@editor-toolbar-run-step-bar-margin: round(-170px/2 + 10px/2 + 2);
...
.animation(@name, @time, @timing-function: linear, @count: infinite, @direction: normal) {
	-animation-name: @name;
