...
module.exports.UI.prototype = {
	...
	init: function($main, globalOptions) {
		...
		this.$arrow = $('<div class="ui-arrow"><div class="ui-arrow-head"></div><div class="ui-arrow-body"></div></div>');
	...
	showArrow: function(left, top) {
		this.$arrow.addClass('ui-arrow-active');
		this.$arrow.css('left', left);
		this.$arrow.css('top', top);
	},

	hideArrow: function() {
		this.$arrow.removeClass('ui-arrow-active');
	},
