...
module.exports = function(info) {
	...
	info.Info.prototype = {
		...
		outputClearEventsFrom: function(eventNum) {
			if (this.scope !== null) this.scope.update(this.events[eventNum].scopeTracker, Infinity);
		...
		outputClearEventsToEnd: function() {
			if (this.scope !== null) this.scope.update(this.lastEvent.scopeTracker, Infinity);
		...
		outputSetEventStep: function(eventNum, stepNum) {
			if (eventNum >= 0 && (this.currentEvent !== this.events[eventNum] || this.stepNum !== stepNum)) {
				...
				if (this.scope !== null) this.scope.update(this.currentEvent.scopeTracker, this.stepNum);
