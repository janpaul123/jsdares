		...
		list: [
			...
			},
			{
				...
				makeContent: function(infoTable, $content) {
					...
					info.robotExample(infoTable, $content, 'function forwardRight(dist) {\n  robot.drive(dist);\n  robot.turnRight();\n}\nforwardRight(3);\nforwardRight(2);\nforwardRight(2);\nforwardRight(1);');
