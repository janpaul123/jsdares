...
var detectGoal = function(object) {
	...
	else return object.state.blockGoal[object.state.robotX][object.state.robotY];
};
...
module.exports = function(output) {
	...
	output.Robot.prototype = {
		...
		init: function(editor, options, $div) {
			...
			this.robot = new robot.Robot(this.$container, this.readOnly, blockSize, JSON.stringify(this.state));
		...
		containerMouseMove: function(event) {
			...
			if (x !== this.state.initialX || y !== this.state.initalY) {
		...
		stateChanged: function() {
			...
			if (this.stateChangedCallback !== null) {
				this.stateChangedCallback(JSON.stringify(this.state));
			}
		}
	};
};