...
module.exports = function(jsmm) {
	...
	jsmm.nodes.Program.prototype.getCompareMainCode = function(functionNames) {
		return this.statementList.getCompareMainCode(functionNames);
	};
	...
	jsmm.nodes.StatementList.prototype.getCompareMainCode = function(functionNames) {
		var output = '';
		for (var i=0; i<this.statements.length; i++) {
