...
module.exports = function(info) {
	info.tables.push({
		html: '<p><span class="info-output"><i class="icon-play icon-white"></i> events</span></p><p>Events are used to add <strong>interactivity</strong> to your program. A <strong>function</strong> of your choice is executed whenever something happens, like when a button is pressed or the mouse is moved.</p>',
		list: {
