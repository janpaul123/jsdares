...
module.exports = function(info) {
	info.tables.push({
		html: '<p><span class="info-table-output"><i class="icon-list-alt icon-white"></i> console</span></p><p>This is used for easily printing any information to the screen, for example when debugging a program, or when calculating something. The console is present in most browsers as an extra tool for developers.</p>',
		list: [
			{
