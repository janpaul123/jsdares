	...
	info.commands = info.commands.concat([
		{
			...
			makeContent: function($content) {
				...
				info.canvasExample($content, '// now we can use the context to draw!\n\ncontext.fillText("Hello World!", 10, 50);');
			}
		},
		{
			name: 'canvas.width',
			...
			makeContent: function($content) {
				...
				info.consoleExample($content, 'console.log(canvas.width);', '540');
			}
		},
		{
			name: 'canvas.height',
			...
			makeContent: function($content) {
				...
				info.consoleExample($content, 'console.log(canvas.height);', '540');
			}
		},
		{
			...
			makeContent: function($content) {
				...
				info.canvasExample($content, 'context.fillRect(20, 40, 10, 10);\ncontext.fillStyle="#a00";\ncontext.fillRect(70, 70, 30, 60);');
			}
		},
		{
			...
			makeContent: function($content) {
				...
				info.canvasExample($content, 'context.strokeRect(20, 40, 10, 10);\ncontext.strokeStyle="#00a";\ncontext.strokeRect(70, 70, 30, 60);');
			}
		},
		{
			...
			makeContent: function($content) {
				...
				info.canvasExample($content, 'context.fillRect(20, 20, 100, 100);\ncontext.clearRect(40, 40, 30, 60);');
			}
		},
		{
			...
			makeContent: function($content) {
				...
				info.canvasExample($content, 'context.fillText("Hello World!", 10, 30);\n\ncontext.fillStyle = "#00a";\ncontext.font = "40pt Calibri";\ncontext.fillText(4*4*4, 50, 80);');
			}
		},
		{
			...
			makeContent: function($content) {
				...
				info.canvasExample($content, 'context.beginPath();\ncontext.moveTo(50, 50);\ncontext.lineTo(100, 100);\ncontext.lineTo(50, 100);\ncontext.stroke();');
			}
		},
		{
