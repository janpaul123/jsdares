...
module.exports = function(client) {
	...
	client.PageHome.prototype = {
		...
		init: function(delegate, $div) {
			...
			this.$aboutText = $('<div class="homepage-about-text"><strong>jsdares</strong> is still very experimental. This means the only a few browsers are supported. Also, it is open source. We need your help to make jsdares more awesome! <a class="homepage-about-link" href="/about">Learn more...</a></div>');
