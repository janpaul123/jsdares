...
module.exports = function(client) {
	...
	client.PageBlog.prototype = {
		...
		blogHTML: [
			...
			'<p style="margin-top: 20px;">',
			'<div class="movie-games-4" style="margin-top: 10px"></div>',
