...
module.exports = function(client) {
	...
	client.PageBlog.prototype = {
		...
		blogHTML: [
			...
			'<p>In small-scale field trials, I’ve found that novices who had never touched any code in their lives, started playing it straight away. <em>Is programming really that easy?</em> To facilitate playing with the code, they can drag numbers to change them.</p>',
			'</div>',
			'<div class="blog-games-piece">',
			...
			'<li>fill the path.</li>',
			'</ol>',
			'This is not acceptable, students should be able to jump in right away.<span class="blog-star">*</span><span class="blog-sidenote" style="margin-top: -150px">* Experts should also not have to go through all that, but they are more used to it, unfortunately.</span></p>',
			...
			'<div class="blog-sidenote" style="width: 300px; top: 410px; text-align: center; right: 25px;">A robot navigating through a maze is a natural visualisation of a depth-first search algorithm.</div>',
			'</div>',
			...
			'<p>The robot environment is a simple piece of code using mostly CSS3 transitions. If you want to use it in your own project, please look at the <a href="https://github.com/janpaul123/robot">stand-alone library</a> that has been extracted out of jsdares!</p>',
			'</div>',
			'<a name="dares"></a>',
