...
module.exports = function(client) {
	...
	client.PageBlog.prototype = {
		...
		blogHTML: [
			...
			'<li>fill the path.</li>',
			'</ol>',
			'This is not acceptable, students should be able to jump in right away.<span class="blog-star">*</span><span class="blog-sidenote">* Experts should also not have to go through all that, but they are more used to it, unfortunately.</span></p>',
