...
module.exports = function(output) {
	...
	output.Home.prototype = {
		init: function(ui, $div) {
			...
			this.$content.append('<p>Works best on the latest versions of <strong>Chrome</strong> and <strong>Firefox</strong>. Please send any bugs, suggestions, and other comments to <a href="mailto:jsdare@janpaulposma.nl">jsdare@janpaulposma.nl</a>. <strong>Thanks!</strong></p>');
