    ...
    constructor: (delegate, $div) ->
      ...
      @$aboutText = $("""
        <div class="homepage-title">
          Make your own <strong>games</strong> by learning <strong>JavaScript</strong> programming!
        </div>

        <p class="homepage-about-text">
          <strong>jsdares</strong> is an open source proof-of-concept.
          <a href="/blindfold" class="homepage-blindfold-link">Learn more&hellip;</a><span>
        </p>
      """)
      ...
      @$how = $("""
        <div class="how">
          <div class="how-header">Getting started</div>
          <div class="how-text">
            <div class="how-text-1">
              You learn programming by completing <strong>dares</strong>.
              These are short puzzles in which you have to copy the example,
            ...
            <div class="how-text-2">
              ...
              You can also play around in the <strong>full editor</strong>.
            </div>
          </div>
        </div>
      """)
