...
var $0 = $$.length - 1;
switch (yystate) {
case 1: this.$ = new yy.Program(this._$, null, $$[$0-1]); return this.$; 
break;
case 2: this.$ = new yy.Program(this._$, null, $$[$0-1]); return this.$; 
break;
case 3: this.$ = new yy.StatementList(this._$, null); 
break;
case 4: this.$ = $$[$0-2]; this.$.addStatement($$[$0-1]); 
break;
case 5: this.$ = $$[$0-2]; this.$.addStatement($$[$0-1]); 
break;
case 6: this.$ = new yy.StatementList(this._$, null); 
break;
case 7: this.$ = $$[$0-2]; this.$.addStatement($$[$0-1]); 
break;
case 8: this.$ = new yy.CommonSimpleStatement(this._$, undefined, $$[$0-1]); 
break;
case 14: this.$ = new yy.PostfixStatement(this._$, undefined, $$[$0-2], $$[$0-1]+$$[$0-1]); 
break;
case 15: this.$ = new yy.AssignmentStatement(this._$, undefined, $$[$0-2], "=", $$[$0]); 
break;
case 16: this.$ = new yy.AssignmentStatement(this._$, undefined, $$[$0-2], $$[$0-1], $$[$0]); 
break;
case 17: this.$ = $$[$0]; 
break;
case 18: this.$ = new yy.VarStatement(this._$, undefined); this.$.addVarItem($$[$0]); 
break;
case 19: this.$ = $$[$0-2]; this.$.addVarItem($$[$0]); 
break;
case 20: this.$ = new yy.VarItem(this._$, undefined, $$[$0], null); 
break;
case 21:
			this.$ = new yy.VarItem(this._$, undefined, $$[$0-2], new yy.AssignmentStatement(this._$, undefined, new yy.NameIdentifier(_$[$0-2], undefined, $$[$0-2]), "=", $$[$0]));
		
break;
case 22: this.$ = new yy.ReturnStatement(this._$, undefined, null); 
break;
case 23: this.$ = new yy.ReturnStatement(this._$, undefined, $$[$0-1]); 
break;
case 25: this.$ = new yy.BinaryExpression(this._$, undefined, $$[$0-2], $$[$0-1], $$[$0]); 
break;
case 27: this.$ = new yy.BinaryExpression(this._$, undefined, $$[$0-2], $$[$0-1], $$[$0]); 
break;
case 29: this.$ = new yy.BinaryExpression(this._$, undefined, $$[$0-2], $$[$0-1], $$[$0]); 
break;
case 31: this.$ = new yy.BinaryExpression(this._$, undefined, $$[$0-2], $$[$0-1], $$[$0]); 
break;
case 33: this.$ = new yy.BinaryExpression(this._$, undefined, $$[$0-2], $$[$0-1], $$[$0]); 
break;
case 35: this.$ = new yy.UnaryExpression(this._$, undefined, $$[$0-1], $$[$0]); 
break;
case 36: this.$ = new yy.UnaryExpression(this._$, undefined, $$[$0-1], $$[$0]); 
break;
case 38: this.$ = new yy.NumberLiteral(this._$, undefined, $$[$0]); 
break;
case 39: this.$ = new yy.StringLiteral(this._$, undefined, $$[$0]); 
break;
case 40: this.$ = new yy.BooleanLiteral(this._$, undefined, true); 
break;
case 41: this.$ = new yy.BooleanLiteral(this._$, undefined, false); 
break;
case 43: this.$ = $$[$0-1]; 
break;
case 44: this.$ = new yy.NameIdentifier(this._$, undefined, $$[$0]); 
break;
case 45: this.$ = new yy.ObjectIdentifier(this._$, undefined, $$[$0-2], $$[$0]); 
break;
case 46: this.$ = new yy.ArrayIdentifier(this._$, undefined, $$[$0-3], $$[$0-1]); 
break;
case 47: this.$ = new yy.FunctionCall(this._$, undefined, $$[$0-2], []); 
break;
case 48: this.$ = new yy.FunctionCall(this._$, undefined, $$[$0-3], $$[$0-1]); 
break;
case 49: this.$ = [$$[$0]]; 
break;
case 50: this.$ = $$[$0-2]; this.$.push($$[$0]); 
break;
case 51: this.$ = new yy.CallStatement(this._$, undefined, $$[$0]); 
break;
case 55: this.$ = new yy.IfBlock(this._$, _$[$0-5].last_column, $$[$0-6], $$[$0-2], $$[$0]); 
break;
case 56: this.$ = null; 
break;
case 57: this.$ = new yy.ElseIfBlock(this._$, _$[$0-1].last_column, $$[$0]); 
break;
case 58: this.$ = new yy.ElseBlock(this._$, _$[$0-4].last_column, $$[$0-1]); 
break;
case 59: this.$ = new yy.WhileBlock(this._$, _$[$0-4].last_column, $$[$0-5], $$[$0-1]); 
break;
case 60: this.$ = new yy.ForBlock(this._$, _$[$0-4].last_column, $$[$0-9], $$[$0-7], $$[$0-5], $$[$0-1]); 
break;
case 61: this.$ = new yy.FunctionDeclaration(this._$, _$[$0-4].last_column, $$[$0-6], [], $$[$0-1]); 
break;
case 62: this.$ = new yy.FunctionDeclaration(this._$, _$[$0-4].last_column, $$[$0-7], $$[$0-5], $$[$0-1]); 
break;
case 63: this.$ = [$$[$0]]; 
break;
...
lexer.rules = [/^((?:((?:[ \f\r\t\v\u00A0\u2028\u2029]+))|((?:[/][/][^\n]*))|((?:[/][*]([^*]*[*][^/])*[^*]*[*][/]))))/,/^(\+=|-=|\*=|\/=|%=)/,/^(==|!=|>=|<=|>|<)/,/^&&/,/^\|\|/,/^=/,/^(\+|-)/,/^(\*|\/|%)/,/^;/,/^!/,/^\(/,/^\)/,/^\{/,/^\}/,/^\[/,/^\]/,/^\./,/^,/,/^((?:null|break|case|catch|default|finally|instanceof|new|continue|void|delete|this|do|in|switch|throw|try|typeof|with|abstract|boolean|byte|char|class|const|debugger|double|enum|export|extends|final|float|goto|implements|import|int|interface|long|native|package|private|protected|public|short|static|super|synchronized|throws|transient|volatile|arguments|NaN|Array|Object|RegExp|toString|jsmm|jsmmparser|jsmmExecutionCounter|jsmmtemp|jsmmscope|jsmmscopeInner|jsmmscopeOuter|jsmmtree))(?!([0-9a-zA-Z_]))/,/^true\b/,/^false\b/,/^if\b/,/^((?:(?:[\n]((?:((?:[ \f\r\t\v\u00A0\u2028\u2029]+))|((?:[/][/][^\n]*))|((?:[/][*]([^*]*[*][^/])*[^*]*[*][/]))))?)+))?else\b/,/^while\b/,/^for\b/,/^var\b/,/^function\b/,/^return\b/,/^([a-zA-Z_])([0-9a-zA-Z_])*/,/^((?:(?:[\n]((?:((?:[ \f\r\t\v\u00A0\u2028\u2029]+))|((?:[/][/][^\n]*))|((?:[/][*]([^*]*[*][^/])*[^*]*[*][/]))))?)+))/,/^((?:(?:(?:[1-9]([0-9])*)|0)((?:\.([0-9])+))?((?:[eE][+-]?([0-9])+))?))/,/^((?:["][^\\"\n]*(?:[\\][nt"\\][^\\"]*)*["]))/,/^$/];
