...
lexer.rules = [/^((?:((?:[ \f\r\t\v\u00A0\u2028\u2029]+))|((?:[/][/][^\n]*))|((?:[/][*]([^*]*[*][^/])*[^*]*[*][/]))))/,/^(\+=|-=|\*=|\/=|%=)/,/^(==|!=|>=|<=|>|<)/,/^&&/,/^\|\|/,/^=/,/^(\+|-)/,/^(\*|\/|%)/,/^;/,/^!/,/^\(/,/^\)/,/^\{/,/^\}/,/^\[/,/^\]/,/^\./,/^,/,/^((?:null|break|case|catch|default|finally|instanceof|new|continue|void|delete|this|do|in|switch|throw|try|typeof|with|abstract|boolean|byte|char|class|const|debugger|double|enum|export|extends|final|float|goto|implements|import|int|interface|long|native|package|private|protected|public|short|static|super|synchronized|throws|transient|volatile|arguments|NaN|Array|Object|RegExp|toString|jsmm|jsmmparser|jsmmExecutionCounter|jsmmCallStackDepth|jsmmtemp|jsmmscope|jsmmscopeInner|jsmmscopeOuter|jsmmtree))(?!([0-9a-zA-Z_]))/,/^true\b/,/^false\b/,/^if\b/,/^((?:(?:[\n]((?:((?:[ \f\r\t\v\u00A0\u2028\u2029]+))|((?:[/][/][^\n]*))|((?:[/][*]([^*]*[*][^/])*[^*]*[*][/]))))?)+))?else\b/,/^while\b/,/^for\b/,/^var\b/,/^function\b/,/^return\b/,/^([a-zA-Z_])([0-9a-zA-Z_])*/,/^((?:(?:[\n]((?:((?:[ \f\r\t\v\u00A0\u2028\u2029]+))|((?:[/][/][^\n]*))|((?:[/][*]([^*]*[*][^/])*[^*]*[*][/]))))?)+))/,/^((?:(?:(?:[1-9]([0-9])*)|0)((?:\.([0-9])+))?((?:[eE][+-]?([0-9])+))?))/,/^((?:["][^\\"\n]*(?:[\\][nt"\\][^\\"]*)*["]))/,/^$/];
